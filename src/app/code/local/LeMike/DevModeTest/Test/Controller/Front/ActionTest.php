 ...
 * @since     0.4.0
 */
class LeMike_DevModeTest_Test_Controller_Front_ActionTest extends
    LeMike_DevModeTest_Test_AbstractCase
{
    /**
    ...
    public function testCheckAuth_Restricted()
    {
        ...
        $authHelper = Mage::helper($this->getModuleAlias('/auth'));
        ...
        /** @var LeMike_DevMode_Controller_Front_Action|PHPUnit_Framework_MockObject_MockObject $object */
        $object = $this->getMock(
